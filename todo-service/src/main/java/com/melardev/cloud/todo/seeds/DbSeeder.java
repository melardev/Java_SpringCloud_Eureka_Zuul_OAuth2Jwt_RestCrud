package com.melardev.cloud.todo.seeds;


import com.github.javafaker.Faker;
import com.melardev.cloud.todo.entities.Todo;
import com.melardev.cloud.todo.repositories.TodosRepository;
...
public class DbSeeder implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        LongStream.range(0, todosToSeed).forEach(i -> todosRepository.save(
                new Todo(
